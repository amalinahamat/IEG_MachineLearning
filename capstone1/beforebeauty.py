...
def print_colored_centered(text, color_code, width):
...
def accidentReport(file, car_choice, selected_booking):
    try:
        ...
        if startRent <= accident_date <= endRent:
            ...
            print("The accident date is outside the rental period.")
