...
def selectCar(cars, booking, file):
    try:
        ...
        if choice < 1 or choice >= len(lines):
            ...
            bookingRelated = [line.strip() for line in booking_lines[0:] if line.startswith(selected_car)]
    ...
    try:
        with open(file, "rt") as filehandler:
            ...
            for index, line in enumerate(data[1:], start=1):  # Skip header and enumerate from 1
                ...
                print(report_line)  # Display report lines
            ...
            if confirm.lower() == 'y':
                ...
                index = keyboard_input(int, "Please key in the index of the Report: ", "Index must be an integer")
...
# Functions keyboard_input, date_input, and time_input should be defined elsewhere in your code.
